...
# Open the .las file
las_file_back = laspy.read("C:/Users/elaub/OneDrive - NTNU/Documents/5.aret/Master/Ballangen/Scan/Pile 2_back.las")
...
#------------------------------------------------------------------------------------#
#Front
las_file_front = laspy.read("C:/Users/elaub/OneDrive - NTNU/Documents/5.aret/Master/Ballangen/Scan/Pile 2_front.las")
...
df.to_csv("particle_sizes_pile_2.csv", index=False)
...
def plot_psd(df, bin_size=0.001):
    ...
    plt.tight_layout()
    plt.savefig('particle_size_distribution_pile_2.png', dpi=300)
    plt.show()
