...
df.to_csv("C:/Users/elaub/OneDrive - NTNU/Documents/5.aret/Master/Koder/particle_sizes_pile_1.csv", index=False)
print("Particle sizes with Feret diameters and percentages saved as particle_sizes_pile_1.csv \n")
