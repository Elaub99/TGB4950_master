...
dbscan_back_right = DBSCAN(eps_back_right, min_samples=min_samples)
...
dbscan_back_left = DBSCAN(eps_back_left, min_samples=min_samples)
...
dbscan_front_right = DBSCAN(eps_front_right, min_samples=min_samples)
...
dbscan_front_left = DBSCAN(eps_front_left, min_samples=min_samples)
...
df.to_csv("C:/Users/elaub/OneDrive - NTNU/Documents/5.aret/Master/Koder/particle_sizes_pile_3.csv", index=False)
