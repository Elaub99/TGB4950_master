# -*- coding: utf-8 -*-
"""
Created on Tue Apr 22 13:04:39 2025
...
las_file_back = laspy.read("C:/Users/elaub/OneDrive - NTNU/Documents/5.aret/Master/Verdal/Tur 17.03/Scan/5001_back.las")
...
dbscan_back = DBSCAN(eps_back, min_samples=min_samples)
...
#------------------------------------------------------------------------------------#
#Front
las_file_front = laspy.read("C:/Users/elaub/OneDrive - NTNU/Documents/5.aret/Master/Verdal/Tur 17.03/Scan/5001_front.las")
points_front = np.vstack((las_file_front.x, las_file_front.y, las_file_front.z)).T

eps_front = 0.011

dbscan_front = DBSCAN(eps_front, min_samples=min_samples)
